<div class="panel">
	<div class="panel-heading">
		<h4 class="panel-title">Daftar buku</h4>
	</div>
	<div class="panel-body">
		...
		<?php endif ?>
		<center><a href="#modalTambah" data-toggle="modal" class="btn btn-info">Tambah</a></center><br>
			...
			<tbody>
				<?php foreach ($tampil_buku as $buku): ?>
					<tr > 
						...
						<td>
							<a href="#edit" onclick="edit(<?=$buku->id_buku?>)" class="btn btn-success" data-toggle="modal">Ubah</a>
